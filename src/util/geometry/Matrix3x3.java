...
public class Matrix3x3 {
    ...
    public static Matrix3x3 newPointAt(Vector2D f, Vector2D r, Vector2D up, Vector2D offset) {
    ...
    public static Matrix3x3 newLookAt(Vector2D f, Vector2D r, Vector2D up, Vector2D offset) {
        return new Matrix3x3(
                new float[][] {
                        { r.x, up.x, f.x },
                        { r.y, up.y, f.y},
