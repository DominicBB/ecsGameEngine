...
public class TriangleRasterizer {
    ...
    private final Vec4fi fragColor = Vec4fi.newZeros(Rasterfi.D_SHIFT_COLOR), fragUtil = Vec4fi.newZeros(Rasterfi.D_SHIFT_COLOR);
    ...
    private void setUpEdges(VOutfi maxY, VOutfi midY, VOutfi minY) {
        int eIndex = 0;
        if ((maxY.p_proj.y >> Rasterfi.D_SHIFT_INV) >= 1080 || (midY.p_proj.y >> Rasterfi.D_SHIFT_INV) >= 1080 || (minY.p_proj.y >> Rasterfi.D_SHIFT_INV) >= 1080) {
            eIndex = 0;
        }
        VOutfi temp;
        ...
        int ceil_maxY = Rasterfi.ceil_pos(maxY.p_proj.y);
        int ceil_midY = Rasterfi.ceil_pos(midY.p_proj.y);
        int ceil_minY = Rasterfi.ceil_pos(minY.p_proj.y);
