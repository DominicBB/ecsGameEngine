...
public class GouruadInterpolants implements IInterpolants {
    ...
    public void reset(VOutfi v) {
        reset(v.p_proj.x, v.p_proj.z, v.invW, v.specularity, v.surfaceColor.x, v.surfaceColor.y, v.surfaceColor.z,
    ...
    public void reset(int xInt, int x, int z, int invW, int specularity, int color_r, int color_g,
                      int color_b, int color_a, int tex_u, int tex_v, int spec_u, int spec_v) {
        this.xInt = xInt;
        this.reset(x, z, invW, specularity, color_r, color_g, color_b, color_a, tex_u, tex_v, spec_u, spec_v);
    }
}
